...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    keywords: ["Castlevania Belmont's Curse Wiki", "Belmont's Curse wiki", "Belmont's Curse fan wiki", "Castlevania fan community wiki", "Belmont's Curse Metroidvania guides"],
  };
}
