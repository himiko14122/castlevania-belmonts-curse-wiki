...
export default async function CatchAllPage({ params }: { params: Promise<{ locale: string; slug: string[] }> }) {
  ...
  if (isContentType(first)) {
    ...
    const GUIDE_STOP_WORDS = new Set(['castlevania', 'belmont', 'belmonts', 'curse', 'guide', 'guides', 'wiki', 'boss', 'bosses', 'arcana', 'weapon', 'weapons', 'relic', 'relics', 'map', 'maps', 'location', 'locations', 'character', 'characters', 'story', 'secret', 'secrets', 'collectible', 'collectibles', 'edition', 'editions', 'preorder', 'pre-order', 'news', 'update', 'updates', 'game', 'mode', 'list', 'complete', 'ultimate', 'best', 'build', 'tips', 'walkthrough', 'the', 'a', 'an', 'and', 'or', 'in', 'on', 'at', 'to', 'for', 'is', 'it', 'how', 'what', 'all', 'vs']);
